---
title: "DifeCo: Differential Cooccurrence or Mutual Exclusion of Binary Genomic Alteration Data"
...
```{r, eval=TRUE}
  ...
  sig_DC<-sta_DC$Stat
#Extract the gene pairs with significant differential cooccurrence/mutual exclusion. LogOR>0 implies cooccurrence while <0 for mutual exclusion
