#' @title DC.CO_plot
#'
#' @description Plot the cooccurrence/mutual exclusivity or differential cooccurrence/mutual exclusivity result
#'
#' @param obj Object generated by Stat.Extraction function. Required
#' @param col_negOR Color palette to color mutual exclusivity paires from stong to weak. Optional. Default: c("blue","light blue")
#' @param col_zero Color palette to color paires with no/very week cooccurrence/mutual exclusivity. Optional. Default: c("white")
